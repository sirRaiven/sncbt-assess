  ...
  <div class="mx-auto max-w-4xl">
    <UCard>
      ...
      <UAlert
        ...
        color="success"
        variant="soft"
        title="Registration preview completed"
        description="The production version will create the Supabase account and send email confirmation."
       />
      <form
        v-else
        class="space-y-5"
      ...
      >
        ...
        <div class="grid gap-5 md:grid-cols-2">
          ...
          <UFormField :label="r==='Student'?'Student number':'Employee number'">
            <UInput class="w-full" />
          </UFormField>
        </div>
